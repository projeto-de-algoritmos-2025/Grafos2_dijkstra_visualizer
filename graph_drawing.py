...
def desenhar_grafo(grafo, posicoes_nos, estado_algoritmo, caminho_final):
    ...
    Recebe todos os dados necessários como argumentos.
    """
    ...
    for no, vizinhos in grafo.items():
        for vizinho, peso in vizinhos.items():
            ...
            ax.annotate("", xy=pos_vizinho, xycoords='data', xytext=pos_no, textcoords='data',
                        arrowprops=dict(arrowstyle="->", color=cor_aresta, shrinkA=15, shrinkB=15,
                                        linewidth=largura_linha, connectionstyle="arc3,rad=0.1"))
